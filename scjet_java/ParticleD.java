...
public class ParticleD implements Comparable<ParticleD>, Serializable  {
	 ...
	 */
	public double eta()  {
		if (px == 0.0 && py ==0.0) return -999;
		if (pz == 0.0) return -999;
	...
	*/
	...
	public double rapidity()  {
		rapidity=-10e10;
		if (energy>pz())  rapidity=0.5*Math.log( (energy+pz)/(energy-pz) );
		return rapidity;
	}
	...
	*/
	...
	/**
	  ...
	  * for fast retrival using getPhi, getRapidity methods. 
	  * @param a
	  * @param index index of the particle to be stored
	  */
